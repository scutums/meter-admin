...
📋 *инфо*  
Получите общую информацию по вашему участку: номер, владелец, контактный телефон, адрес и текущий статус.

📊 *показания*  
Показывает последние переданные показания электросчетчика с указанием даты и количества потребленной электроэнергии.

💰 *история оплат*  
Посмотрите историю ваших платежей за электроэнергию с датами и суммами. Удобно для контроля и отслеживания.

💳 *реквизиты*  
Получите актуальные реквизиты для оплаты — включая наименование получателя, IBAN, назначение платежа и, если доступно, QR-код для быстрой оплаты.

📈 *расход*  
Узнайте, сколько электроэнергии вы потребили за последний месяц или другой выбранный период, а также сумму начислений.

🔔 *уведомления*  
Настройте получение напоминаний о передаче показаний и необходимости оплаты. Можно включить или отключить уведомления в любой момент.

❌ *отвязать*  
Удалите привязку между вашим Viber-аккаунтом и участком. После этого команды бота станут недоступны до повторной привязки.

❓ *помощь*  
Показать этот список команд. Используйте эту команду, если забыли, какие функции доступны в боте.
`;
