...
export default function viberRoutes(db) {
  ...
  function getCommandButtons() {
    return [
      { text: "📋 Инфо", command: "инфо", bgColor: "#4CAF50", textColor: "#FFFFFF" },           // Зеленый
      { text: "📊 Показания", command: "показания", bgColor: "#2196F3", textColor: "#FFFFFF" }, // Синий
      { text: "💰 Оплата", command: "оплата", bgColor: "#FF9800", textColor: "#FFFFFF" },       // Оранжевый
      { text: "📈 Расход", command: "расход", bgColor: "#9C27B0", textColor: "#FFFFFF" },       // Фиолетовый
      { text: "🔔 Уведомления", command: "уведомления", bgColor: "#E91E63", textColor: "#FFFFFF" }, // Розовый
      { text: "⏰ Напоминание", command: "напоминание", bgColor: "#607D8B", textColor: "#FFFFFF" }, // Серый
      { text: "📱 Телефон", command: "телефон", bgColor: "#795548", textColor: "#FFFFFF" },     // Коричневый
      { text: "❌ Отвязать", command: "отвязать", bgColor: "#F44336", textColor: "#FFFFFF" },    // Красный
      { text: "❓ Помощь", command: "помощь", bgColor: "#009688", textColor: "#FFFFFF" }         // Бирюзовый
    ];
  }
  ...
  function getRegistrationButtons() {
    return [
      { text: "❌ Отмена", command: "отмена", bgColor: "#F44336", textColor: "#FFFFFF" } // Красный
    ];
  }
      ...
      if (buttons) {
        messageData.keyboard = {
          ...
          Buttons: buttons.map(button => ({
            ...
            BgColor: button.bgColor || "#FFFFFF", // Цвет фона кнопки
            TextColor: button.textColor || "#000000", // Цвет текста кнопки
