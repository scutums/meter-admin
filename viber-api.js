...
📋 *Информация*  
Получите общую информацию по вашему участку: номер, контактное лицо, телефон, последнее показание, последняя оплата.

📊 *Показания*  
Просмотрите все переданные показания вашего электросчётчика.

💰 *История оплат*  
Посмотрите историю ваших платежей за электроэнергию с указанием дат и сумм. Удобно для контроля и отслеживания.

💳 *Реквизиты*  
Получите актуальные реквизиты для оплаты — включая наименование получателя, IBAN и назначение платежа (если доступно).

📈 *Расход*  
Узнайте, сколько электроэнергии вы потребили за текущий месяц, а также средний расход за последние месяцы.

🔔 *Уведомления*  
Настройте получение напоминаний об изменениях в данных вашего счёта. Можно включить или отключить уведомления в любой момент.
